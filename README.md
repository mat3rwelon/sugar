...
```bash
npm install @mat3rwelon/sugar
# or
yarn add @mat3rwelon/sugar
# or
pnpm add @mat3rwelon/sugar
```

## Example

```ts
import { Client } from "@mat3rwelon/sugar";
import { Events, MessageType } from "@mat3rwelon/sugar/lib/Constant";
...
> ```ts
> import { Client } from "@mat3rwelon/sugar";
> import { Events } from "@mat3rwelon/sugar/lib/Constant";
> 
> const bot = new Client({
>     name: "WA Bot",
...
```js
import { Cooldown } from "@mat3rwelon/sugar"; // import Cooldown class
...
- ### Button
  ...
  ```ts
  import { ButtonBuilder } from "@mat3rwelon/sugar";
...
- ### Sections
  ...
  ```ts
  import { SectionBuilder } from "@mat3rwelon/sugar";
...
- ### Contact
  ...
  ```ts
  import { VCardBuilder } from "@mat3rwelon/sugar";
...
- ### Template Buttons
  ...
  ```ts
  import { TemplateButtonsBuilder } from "@mat3rwelon/sugar";

  const templateButtons = new TemplateButtonsBuilder()
        .addURL({ displayText: 'sugar at Github', url: 'https://github.com/mat3rwelon/sugar' })
...
```ts
import { MessageType } from "@mat3rwelon/sugar/lib/Constant";
...
```ts
import { bold, inlineCode, italic, monospace, quote, strikethrough } from "@mat3rwelon/sugar";
